...
describe('collectMetricsData', () => {
  ...
  afterEach(() => {
    MetricsStoreProxy.prototype.query.restore()
  ...
  it('should collect the new data for each metric', async () => {
    ...
    sinon.stub(MetricsStoreProxy.prototype, 'query').returns(metrics)
  ...
  it('should not collect the new data if the admin should post datapoints ', async () => {
    ...
    sinon.stub(MetricsStoreProxy.prototype, 'query').returns([new Metric({metricID: '1', type: 'Mock'})])
    const stub = sinon.stub(Metric.prototype, 'collect').returns()
  ...
  it('should return error on exception thrown', async () => {
    sinon.stub(MetricsStoreProxy.prototype, 'query').throws()
